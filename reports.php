        ...
        <nav class="navbar navbar-expand-sm navbar-default" style="background: #000">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <?php if($user_info['usergroups_id']==1){ ?>
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                    <?php 
                        $check=mysqli_query($connect, "SELECT *  FROM attendances LEFT JOIN employees ON (attendances.employees_id = employees.id)")or die('Unable to select all attendances');
                        if(!empty($check)){
                            $j=0;
