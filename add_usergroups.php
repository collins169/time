<?php include 'functions/add_usergroups.php'; Global $alert; ?>
<!doctype html>
...
<head>
    ...
    <title>Fasly | Add User Groups</title>
                 ...
                 <div class="col-lg-10">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Add User Groups</strong>
                        </div>
                        <div class="card-body">
                          <!-- Credit Card -->
                          <div id="pay-invoice">
                                  ...
                                  <form action="" method="post"  name="add_form" id="add_form">
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                         ...
                                         <textarea id="description" name="description"  style="resize: none;" rows="6" class="form-control"></textarea>
                                      </div>
                                      <button type="submit" class="btn btn-primary btn-sm" name="add" id='add'>
                                      <i class="fa fa-dot-circle-o"></i> Submit
                                        </button>
                                        <a href="usergroups" class="btn btn-danger btn-sm">
