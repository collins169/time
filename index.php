<?php include 'functions/db.php'; Global $alertMessage; ?>
<!doctype html>
         ...
         <?php 
            ...
            <center>
                <div class='alert  alert-success alert-dismissible fade show' role='alert'>
                  <span class='badge badge-pill badge-success'><i class='fa fa-clock-o fa-spin'></i></span> You Have <?php echo $mes ?>
           ...
           <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        <h4 class="mb-0"><?php $check=mysqli_query($connect, "SELECT COUNT(*) AS COUNT FROM employees")or die('Unable to count total number of employees');
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        <h4 class="mb-0"><?php $check2=mysqli_query($connect, "SELECT COUNT(*) AS COUNT FROM attendances WHERE end_time='00:00:00' ")or die('Unable to count total number of logged employees');
                        $total2=mysqli_fetch_assoc($check2); ?>
                            <span class="count"><?php echo $total2['COUNT'] ?></span>
                        </h4>
                        <p class="text-light">Logged Employees</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        <h4 class="mb-0"><?php $check3=mysqli_query($connect, "SELECT COUNT(*) AS COUNT FROM attendances WHERE end_time!='00:00:00'")or die('Unable to count total number of logged employees');
                        $total3=mysqli_fetch_assoc($check2); ?>
                            <span class="count"><?php if(!empty($total3['COUNT'])){echo $total3['COUNT'];}else{echo '0';} ?></span>
                        </h4>
                        <p class="text-light">Not Logged</p>
