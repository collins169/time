<?php include 'functions/add.php'; GLOBAL $alert; ?>
<!doctype html>
                                  ...
                                  <form action="" method="post"  name="add_form" id="add_form">
                                    <div class="row">
                                        <div class="col-md-4">
                                          <div class="form-group">
                                              ...
                                              <input id="first_name" name="first_name" type="text" class="form-control" aria-required="true" aria-invalid="false" required\>
                                          </div>
                                        </div>
                                        <div class="col-md-4">
                                              <div class="form-group has-success">
                                                  <label for="middle_name" class="control-label mb-1">Middle Name</label>
                                                  <input id="middle_name" name="middle_name" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                          <div class="form-group">
                                              ...
                                              <input id="username" name="username" type="text" class="form-control" aria-required="true" aria-invalid="false" required\>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="form-group">
                                              <label for="image" class="control-label mb-1">Image</label>
                                              <input id="image" name="image" type="file" accept="image/png, image/jpg, image/jpeg" class="form-control" aria-required="true" aria-invalid="false" required\>
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class='form-group'>
                                                <label for='usergroup' class='control-label mb-1'> Usergroup</label>
                                                <select data-placeholder="Choose a Usergroup..." id='usergroup' name="usergroup" class="form-control standardSelect" tabindex="1" required>
                                                    <option value=""></option>
                                                     <?php $check=mysqli_query($connect, "SELECT * FROM user_groups ORDER BY title ASC");
                                                        foreach($check as $get){ ?>
                                                        <option value="<?php echo $get['id'] ?>"><?php echo $get['title'] ?></option>
                                                        <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class='form-group'>
                                                ...
                                                <select data-placeholder="Choose a Country..." class="form-control standardSelect" tabindex="1" name="country" id="country">
                                                    <option value=""></option>
                                                    <?php $check=mysqli_query($connect, "SELECT * FROM countries ORDER BY country_name ASC");
                                                        foreach($check as $get){ ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-group input-medium date" data-date-format="yyyy-mm-dd" id='date-picker'>
                                            ...
                                            <input type="text" class="form-control" autocomplete="off" name="dob" id="date-picker" required>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                          ...
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  <label for="cpassword" class="control-label mb-1">Confirm Password</label>
                                                  <input id="cpassword" name="cpassword" type="password" class="form-control" aria-required="true" aria-invalid="false">
                                                  <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                              </div>
                                            </div>
                                        </div>
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-6">
                                              ...
                                              <div class="form-group">
                                                 ...
                                                 <textarea id="address" name="address" type="textarea" style="resize: none;" rows="6" class="form-control" aria-required="true" aria-invalid="false"></textarea>
                                                  <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                              </div>
                                      <div>
                                      <button type="submit" class="btn btn-primary btn-sm" name="add" id='add'>
