                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">My Reports</strong>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <?php 
                    $id=$user_info['id'];
                        $check=mysqli_query($connect, "SELECT *  FROM attendances LEFT JOIN employees ON (attendances.employees_id = employees.id)WHERE attendances.employees_id=$id")or die('Unable to select all attendances');
                        if(!empty($check)){
                            $j=0;
