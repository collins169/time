<?php include 'functions/add.php';
    ...
    if(isset($_GET['edit'])){
        ...
        echo "<script>alert('Employee does not exist')window.location.href='employees.php'</script>
                                                        ";
    }
                                        ...
                                        <div class="col-md-4">
                                            <div class='form-group'>
                                                ...
                                                <select data-placeholder="Choose a Usergroup..." id='usergroup' name="usergroup" class="form-control standardSelect" tabindex="1" required>
                                                    <option value=""></option>
                                                     <?php 
                                                    $check=mysqli_query($connect, "SELECT * FROM user_groups ORDER BY title ASC");
                                                    foreach($check as $get){
                                                ?> 
                                                <?php if($get['title']==$usergroups){ ?>
                                                    <option value="<?php echo $usergroups_id ?>" selected><?php echo $usergroups ?></option>
                                                    <?php }else { ?>
